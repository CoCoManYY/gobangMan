<template>
    <div class="home">
        ...
        <popover ref="winPop"><img src="../../public/img/win.png" height="240px" width="240px"/></popover>
        <popover ref="losePop"><img src="../../public/img/lose.png"/></popover>
    </div>
</template>
