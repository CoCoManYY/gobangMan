...
import {ADD_CHESSMAN, RESET_BOARD, SET_BOARD, SET_FIRST, SET_FIVES, SET_STATUS, SET_STEPS} from '@/store/mutations'
                ...
                if (b) {
                    ...
                    for (var i = 0; i < b.length; i++) {
                        for (var j = 0; j < b.length; j++) {
                            ...
                            const r = b[i][j]
                            if (r === 1) {
                                third = {position: [i, j], role: 1}
                                steps.push(third)
                            }
                            if (r === 2) {
                                second = {position: [i, j], role: 2}
                                steps.push(second)
                            }
                        }
                    }
